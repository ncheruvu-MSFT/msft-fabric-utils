...
SUB=os.environ.get("AZURE_SUBSCRIPTION","00000000-0000-0000-0000-000000000000")
...
def main():
    ...
    # Fabric tenant
    put_ds("ds_fabric","Fabric",{"tenant":os.environ.get("AZURE_TENANT","00000000-0000-0000-0000-000000000000"),
        "collection":coll})
