...
1. **Service connection (FIC / WIF)** — ARM service connection of type *Workload identity federation*, scoped to the SPN granted on Fabric + Purview. **No client secret.**
   This repo uses the existing connection **`azure-fabric-sso`** (Entra app `47a48c18-47f4-4f90-a5e7-f5add3cb2ee3`, subscription `31613fe0-1e9b-4a97-b771-dc48fbaa0fbb`).
